...
%>
       ...
       <div class="navbar-header">
         ...
         <a class="navbar-brand" href="<%= request.getContextPath() %>/"><img height="35px" src="<%= request.getContextPath() %>/image/logo-furg-topo.png" /></a>
       </div>
          ...
          <li class="dropdown">
           ...
           <li class="dropdown">
             ...
             <ul class="dropdown-menu">
               ...
               <li><a href="<%= request.getContextPath() %>/dspace-admin/productivityreport"><fmt:message key="jsp.layout.navbar-admin.productivityreport"/></a></li>               
            </ul>
          </li>
